...
angular.module('mean.ffxivCrafter').directive('forumCategory', function () {
  return {
    templateUrl: '/ffxivCrafter/views/forum/category.html',
    scope: {
    ...
    controller: function ($scope, $q, _, ForumCategory, socket, ForumThread, ForumPost, $mdDialog, MeanUser, $location) {
      ...
      $scope.createSubCategoryDialog = function () {
        $mdDialog.show({
          templateUrl: 'ffxivCrafter/views/forum/newCategoryDialog.html',
      ...
      $scope.createThreadDialog = function () {
        $mdDialog.show({
          templateUrl: 'ffxivCrafter/views/forum/newThreadDialog.html',
          parent: angular.element(document.body),
          clickOutsideToClose: true,
          controller: DialogController
        }).then(function (data) {
